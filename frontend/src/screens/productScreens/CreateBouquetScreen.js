                ...
                <div className="items">
                    ...
                    <Container>
                        <Row>
                            <Col xs={12} md={3}>
                                <div>
                                    <Button variant="link" onClick={() => setSelectedCategory('flowers')}
                                            style={{textDecoration: 'none', color: ' #114232'}}>
                                        Flowers
                                    </Button>{' '}
                                    <Button variant="link" onClick={() => setSelectedCategory('packings')}
                                            style={{textDecoration: 'none', color: ' #114232'}}>
                                        Packings
                                    </Button>
                                </div>
                                ...
                                {filteredItems().length > itemsPerPage && (
                                    <div className="pagination-list">
                                        <div className="page-item">
                                            <Button variant="link" onClick={prevPage} disabled={currentPage === 1}
                                                    className="page-link">
                                                Previous
                                            </Button>
                                        </div>
                                            ...
                                            if (i + 1 >= currentPage - 2 && i + 1 <= currentPage + 2) {
                                                return (
                                                    <div key={i + 1}
                                                        ...
                                                        <Button variant="link" onClick={() => setCurrentPage(i + 1)}
                                                                className="page-link">
                                                            {i + 1}
                                                        </Button>
                                                    </div>
